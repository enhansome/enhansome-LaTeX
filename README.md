...
* [dante-ev/docker-texlive](https://github.com/dante-ev/docker-texlive) ⭐ 117 | 🐛 7 | 🌐 Dockerfile | 📅 2026-06-28 - debian-based full TeXLive system with additions with pandoc, perl, and python pre-installed
* [reitzig/texlive-docker](https://github.com/reitzig/texlive-docker) ⭐ 31 | 🐛 2 | 🌐 Dockerfile | 📅 2026-08-17 - minimal TeXLive system with package installation possibility
...
* [xhub](https://github.com/nschloe/xhub) ⭐ 106 | 🐛 11 | 🌐 JavaScript | 📅 2025-08-31 - Browser extension that lets you use LaTeX in GitHub pages. ![foss]
...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 76 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-25 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,975 | 🐛 50 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,288 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-25 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,959 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,351 | 🐛 2 | 🌐 TeX | 📅 2026-08-22 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
  * [LaTeX Live Preview](https://github.com/xuhdev/vim-latex-live-preview) ⭐ 853 | 🐛 25 | 🌐 Vim Script | 📅 2025-11-03 - Instantly previews your LaTeX document. ![foss]
  * [Vim-LaTeX](http://vim-latex.sourceforge.net) ![foss]

* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,368 | 🐛 38 | 📅 2026-05-13 ![foss]
...
* [Atom](https://atom.io) [![Atom][awesome]](https://github.com/mehcode/awesome-atom) ⚠️ Archived ![foss]
  * [LaTeXTools](https://atom.io/packages/latextools) - Atom port of the Sublime Text package of the same name. ![foss]

* [Sublime Text](https://www.sublimetext.com) [![Sublime Text][awesome]](https://github.com/dreikanter/sublime-bookmarks) ⭐ 1,074 | 🐛 1 | 📅 2024-01-15
  * [LaTeXTools](https://github.com/SublimeText/LaTeXTools) ⭐ 2,022 | 🐛 64 | 🌐 Common Workflow Language | 📅 2026-07-30 - Free LaTeX plugin for Sublime Text. ![foss]
  * [LaTeXing](https://github.com/LaTeXing/LaTeXing) ⭐ 82 | 🐛 141 | 🌐 Python | 📅 2019-03-19 - Free plug-in to edit LaTeX. ![foss]

* [IntelliJ](https://www.jetbrains.com/idea/)
  * [TeXiFy-IDEA](https://github.com/Hannah-Sten/TeXiFy-IDEA) ⭐ 984 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-20 - Free LaTeX plugin for IntelliJ IDEA. ![foss]

### Online editors

Online editors that allow you to edit documents collaboratively.

* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,069 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 165 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
* [WebLaTeX](https://github.com/sanjib-sen/weblatex) ⭐ 1,743 | 🐛 16 | 🌐 TeX | 📅 2024-05-23 - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
* [Modern LaTeX Editor](https://github.com/InMDev/Modern-LaTeX-Editor) ⭐ 39 | 🐛 13 | 🌐 JavaScript | 📅 2026-06-27 - Online editor, no-signup hybrid code editor + visual editor that mixes Notion/Google docs/Microsoft Word-like editing with raw LaTeX code blocks.
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 8 | 🌐 Python | 📅 2026-08-24 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [TexLab](https://github.com/latex-lsp/texlab) ⭐ 2,010 | 🐛 78 | 🌐 Rust | 📅 2026-07-27 - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

* [Papis](https://github.com/papis/papis) ⭐ 1,769 | 🐛 79 | 🌐 HTML | 📅 2026-08-23 - Extremely customizable,
...
* [OneCite](https://github.com/HzaCode/OneCite) ⭐ 65 | 🐛 1 | 🌐 Python | 📅 2026-08-06 - Universal citation management and academic reference toolkit that converts messy references into perfectly formatted citations. Supports DOI, arXiv ID, titles, and more, with output in BibTeX, APA, and MLA formats. ![mac] ![windows] ![linux] ![foss]
* [CrossRef Local](https://github.com/ywatanabe1989/crossref-local) ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2026-08-19 - Local CrossRef database (167M papers) with full-text search, impact factor data, Python API for bibliography enrichment, and an MCP server (15 tools). ![foss]
* [OpenAlex Local](https://github.com/ywatanabe1989/openalex-local) ⭐ 4 | 🐛 2 | 🌐 Python | 📅 2026-08-19 - Local OpenAlex database (284M scholarly works) with abstracts and semantic search for literature discovery, and an MCP server. ![foss]
...
* [Arara](https://www.ctan.org/pkg/arara) ([GitHub repo](https://github.com/islandoftex/arara) ⭐ 417 | 🐛 11 | 🌐 Kotlin | 📅 2026-07-12) - Simple tool that allows you to specify which tools to call inside your document and it can be extended quite easily. ![foss]
...
* [xu-cheng/latex-action](https://github.com/xu-cheng/latex-action) ⭐ 1,410 | 🐛 1 | 🌐 Shell | 📅 2026-07-30 - GitHub Action to compile LaTeX documents
* [dante-ev/latex-action](https://github.com/dante-ev/latex-action) ⭐ 194 | 🐛 5 | 🌐 TeX | 📅 2026-06-28 - DANTE e.V.'s GitHub action to compile LaTeX documents. Offers a full TeXLive and pre-installed perl and python.
...
* [SciTeX Writer](https://github.com/ywatanabe1989/scitex-writer) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-08-24 - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
* [tex-fmt](https://github.com/WGUNDERWOOD/tex-fmt) ⭐ 863 | 🐛 36 | 🌐 Rust | 📅 2026-08-22 - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [TeXtidote](https://github.com/sylvainhalle/textidote) ⭐ 1,056 | 🐛 38 | 🌐 Java | 📅 2026-08-21 - A cross-platform (Java) spelling, grammar and style checker for LaTeX documents. ![windows] ![linux] ![mac] ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 65 | 🐛 3 | 🌐 Rust | 📅 2026-08-25 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
* [latex2arxiv](https://github.com/YuZh98/latex2arxiv) ⭐ 5 | 🐛 1 | 🌐 Python | 📅 2026-07-30 - CLI tool that prepares a LaTeX project for arXiv submission: prunes unreachable files, strips draft markup, validates the bibliography, and catches desk-rejection errors before upload. Also available as a GitHub Action and MCP server for AI agents. ![windows] ![linux] ![mac] ![foss]
...
* [TikZ-Editor](https://github.com/fredokun/TikZ-Editor) ⭐ 201 | 🐛 14 | 🌐 Python | 📅 2024-03-25 - Live-previewing editor for TikZ figures. ![mac] ![linux] ![foss]
* [TikzEdt](https://www.tikzedt.org) (also: [GitHub repo](https://github.com/hchapman/tikzedt) ⭐ 10 | 🐛 35 | 🌐 C# | 📅 2015-06-08) - WYSIWYG and text-based editor for TikZ pictures. ![foss]
...
* [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) ⭐ 1,739 | 🐛 264 | 🌐 MATLAB | 📅 2026-05-31 - Convert your MATLAB plots to PGFPlots/TikZ. ![windows] ![linux] ![mac] ![foss]
...
* [OpenTikZ](https://github.com/opentikz/opentikz) ⭐ 250 | 🐛 0 | 🌐 TeX | 📅 2026-07-12 - Community library of copyable TikZ icons and editable, parametric templates for academic conceptual diagrams (system/architecture, pipelines, flowcharts); CC0 content, with a Claude Code skill to edit figures on request. ![foss]
...
* [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) ⭐ 1,794 | 🐛 1 | 📅 2026-06-22 - Links to various beamer themes along with PDF previews.
* [TeXtured](https://github.com/jdujava/TeXtured) ⭐ 275 | 🐛 9 | 🌐 TeX | 📅 2026-05-05 - A typographically elegant, clean, and structured LaTeX template (primarily intended for theses).
* [LaTeX Beamer Theme Overview](https://github.com/UweZiegenhagen/LaTeX-Beamer-Theme-Overview/blob/main/OVERVIEW.md) ⭐ 55 | 🐛 1 | 🌐 TeX | 📅 2025-09-05 - Visual overview of beamer themes included in TeXLive
...
* [MartinThoma's LaTeX example](https://github.com/MartinThoma/LaTeX-examples/) ⭐ 1,690 | 🐛 5 | 🌐 TeX | 📅 2024-10-19 - GitHub repository containing example LaTeX documents.
...
* [Awesome LaTeX drawing](https://github.com/xinychen/awesome-latex-drawing) ⭐ 2,045 | 🐛 1 | 🌐 TeX | 📅 2025-05-26 - Curated list of academic drawing examples for using LaTeX
...
* [Begin LaTeX in minutes](https://github.com/luong-komorebi/Begin-Latex-in-minutes) ⚠️ Archived - Brief intro to LaTeX for beginners that helps you use LaTeX with ease.
