...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 141 | 🐛 19 | 🌐 TypeScript | 📅 2026-09-07 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 29,011 | 🐛 57 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,305 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-07 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,971 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,351 | 🐛 2 | 🌐 TeX | 📅 2026-09-05 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,373 | 🐛 34 | 📅 2026-09-02 ![foss]
...
* [Sublime Text](https://www.sublimetext.com) [![Sublime Text][awesome]](https://github.com/dreikanter/sublime-bookmarks) ⭐ 1,076 | 🐛 1 | 📅 2024-01-15
  * [LaTeXTools](https://github.com/SublimeText/LaTeXTools) ⭐ 2,023 | 🐛 64 | 🌐 Common Workflow Language | 📅 2026-07-30 - Free LaTeX plugin for Sublime Text. ![foss]
...
* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,096 | 🐛 175 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 179 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-06 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
* [WebLaTeX](https://github.com/sanjib-sen/weblatex) ⭐ 1,748 | 🐛 16 | 🌐 TeX | 📅 2024-05-23 - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 5 | 🌐 Python | 📅 2026-09-07 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 72 | 🐛 1 | 🌐 Rust | 📅 2026-09-07 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

* [Papis](https://github.com/papis/papis) ⭐ 1,775 | 🐛 85 | 🌐 HTML | 📅 2026-09-01 - Extremely customizable,
...
* [SciTeX Writer](https://github.com/ywatanabe1989/scitex-writer) ⭐ 3 | 🐛 2 | 🌐 Python | 📅 2026-09-06 - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 72 | 🐛 1 | 🌐 Rust | 📅 2026-09-07 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 72 | 🐛 1 | 🌐 Rust | 📅 2026-09-07 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
...
* [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) ⭐ 1,746 | 🐛 264 | 🌐 MATLAB | 📅 2026-05-31 - Convert your MATLAB plots to PGFPlots/TikZ. ![windows] ![linux] ![mac] ![foss]
...
* [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) ⭐ 1,800 | 🐛 1 | 📅 2026-06-22 - Links to various beamer themes along with PDF previews.
...
* [MartinThoma's LaTeX example](https://github.com/MartinThoma/LaTeX-examples/) ⭐ 1,691 | 🐛 5 | 🌐 TeX | 📅 2026-09-04 - GitHub repository containing example LaTeX documents.
...
* [Awesome LaTeX drawing](https://github.com/xinychen/awesome-latex-drawing) ⭐ 2,053 | 🐛 1 | 🌐 TeX | 📅 2025-05-26 - Curated list of academic drawing examples for using LaTeX
