...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 21 | 🐛 13 | 🌐 TypeScript | 📅 2026-08-17 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]

### General purpose text editors

These editors are no one-trick ponies: sure, they edit LaTeX, but they can do a lot more!

* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,958 | 🐛 47 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,275 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-17 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,943 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,345 | 🐛 1 | 🌐 TeX | 📅 2026-08-15 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,358 | 🐛 37 | 📅 2026-05-13 ![foss]
...
* [Sublime Text](https://www.sublimetext.com) [![Sublime Text][awesome]](https://github.com/dreikanter/sublime-bookmarks) ⭐ 1,074 | 🐛 1 | 📅 2024-01-15
  * [LaTeXTools](https://github.com/SublimeText/LaTeXTools) ⭐ 2,022 | 🐛 63 | 🌐 Common Workflow Language | 📅 2026-07-30 - Free LaTeX plugin for Sublime Text. ![foss]
  * [LaTeXing](https://github.com/LaTeXing/LaTeXing) ⭐ 82 | 🐛 141 | 🌐 Python | 📅 2019-03-19 - Free plug-in to edit LaTeX. ![foss]

* [IntelliJ](https://www.jetbrains.com/idea/)
  * [TeXiFy-IDEA](https://github.com/Hannah-Sten/TeXiFy-IDEA) ⭐ 984 | 🐛 3 | 🌐 Kotlin | 📅 2026-08-17 - Free LaTeX plugin for IntelliJ IDEA. ![foss]

### Online editors

Online editors that allow you to edit documents collaboratively.

* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,026 | 🐛 167 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 153 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-08 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 10 | 🌐 Python | 📅 2026-08-17 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 61 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

* [Papis](https://github.com/papis/papis) ⭐ 1,767 | 🐛 88 | 🌐 HTML | 📅 2026-08-16 - Extremely customizable,
...
* [SciTeX Writer](https://github.com/ywatanabe1989/scitex-writer) ⭐ 3 | 🐛 2 | 🌐 Python | 📅 2026-08-16 - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 61 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 61 | 🐛 11 | 🌐 Rust | 📅 2026-08-17 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
