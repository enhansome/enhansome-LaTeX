...
* [reitzig/texlive-docker](https://github.com/reitzig/texlive-docker) ⭐ 31 | 🐛 2 | 🌐 Dockerfile | 📅 2026-09-01 - minimal TeXLive system with package installation possibility
...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 120 | 🐛 22 | 🌐 TypeScript | 📅 2026-09-03 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,999 | 🐛 55 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,304 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-03 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,971 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,352 | 🐛 5 | 🌐 TeX | 📅 2026-08-29 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,370 | 🐛 34 | 📅 2026-09-02 ![foss]
...
* [Sublime Text](https://www.sublimetext.com) [![Sublime Text][awesome]](https://github.com/dreikanter/sublime-bookmarks) ⭐ 1,076 | 🐛 1 | 📅 2024-01-15
...
* [IntelliJ](https://www.jetbrains.com/idea/)
  * [TeXiFy-IDEA](https://github.com/Hannah-Sten/TeXiFy-IDEA) ⭐ 984 | 🐛 4 | 🌐 Kotlin | 📅 2026-09-03 - Free LaTeX plugin for IntelliJ IDEA. ![foss]

### Online editors

Online editors that allow you to edit documents collaboratively.

* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,087 | 🐛 174 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 176 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-01 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
* [WebLaTeX](https://github.com/sanjib-sen/weblatex) ⭐ 1,746 | 🐛 16 | 🌐 TeX | 📅 2024-05-23 - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 11 | 🌐 Python | 📅 2026-09-03 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [TexLab](https://github.com/latex-lsp/texlab) ⭐ 2,013 | 🐛 79 | 🌐 Rust | 📅 2026-07-27 - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 70 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

* [Papis](https://github.com/papis/papis) ⭐ 1,772 | 🐛 85 | 🌐 HTML | 📅 2026-09-01 - Extremely customizable,
...
* [CrossRef Local](https://github.com/ywatanabe1989/crossref-local) ⭐ 5 | 🐛 2 | 🌐 Python | 📅 2026-08-31 - Local CrossRef database (167M papers) with full-text search, impact factor data, Python API for bibliography enrichment, and an MCP server (15 tools). ![foss]
* [OpenAlex Local](https://github.com/ywatanabe1989/openalex-local) ⭐ 4 | 🐛 3 | 🌐 Python | 📅 2026-08-31 - Local OpenAlex database (284M scholarly works) with abstracts and semantic search for literature discovery, and an MCP server. ![foss]
...
* [xu-cheng/latex-action](https://github.com/xu-cheng/latex-action) ⭐ 1,411 | 🐛 1 | 🌐 Shell | 📅 2026-07-30 - GitHub Action to compile LaTeX documents
...
* [SciTeX Writer](https://github.com/ywatanabe1989/scitex-writer) ⭐ 3 | 🐛 3 | 🌐 Python | 📅 2026-08-30 - Manuscript compilation system with templates for manuscripts, revisions, and supplementary materials, plus figure, table, and citation handling, and an MCP server (38 tools). ![foss]
...
* [tex-fmt](https://github.com/WGUNDERWOOD/tex-fmt) ⭐ 863 | 🐛 38 | 🌐 Rust | 📅 2026-08-22 - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 70 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [TeXtidote](https://github.com/sylvainhalle/textidote) ⭐ 1,056 | 🐛 38 | 🌐 Java | 📅 2026-09-01 - A cross-platform (Java) spelling, grammar and style checker for LaTeX documents. ![windows] ![linux] ![mac] ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 70 | 🐛 1 | 🌐 Rust | 📅 2026-09-03 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
...
* [matlab2tikz](https://github.com/matlab2tikz/matlab2tikz) ⭐ 1,745 | 🐛 264 | 🌐 MATLAB | 📅 2026-05-31 - Convert your MATLAB plots to PGFPlots/TikZ. ![windows] ![linux] ![mac] ![foss]
* [PetarV-/TikZ](https://github.com/PetarV-/TikZ) ⭐ 1,417 | 🐛 1 | 🌐 TeX | 📅 2023-05-05 - Collection of publication-ready PGF/TikZ figures by Petar Veličković.
...
* [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) ⭐ 1,797 | 🐛 1 | 📅 2026-06-22 - Links to various beamer themes along with PDF previews.
...
* [Awesome LaTeX drawing](https://github.com/xinychen/awesome-latex-drawing) ⭐ 2,051 | 🐛 1 | 🌐 TeX | 📅 2025-05-26 - Curated list of academic drawing examples for using LaTeX
