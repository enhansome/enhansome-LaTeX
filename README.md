...
* [reitzig/texlive-docker](https://github.com/reitzig/texlive-docker) ⭐ 31 | 🐛 2 | 🌐 Dockerfile | 📅 2026-08-25 - minimal TeXLive system with package installation possibility
...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 80 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-26 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,973 | 🐛 51 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,288 | 🐛 0 | 🌐 TypeScript | 📅 2026-08-26 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,961 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
...
* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,369 | 🐛 38 | 📅 2026-05-13 ![foss]
...
* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,071 | 🐛 168 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 167 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-24 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
* [WebLaTeX](https://github.com/sanjib-sen/weblatex) ⭐ 1,745 | 🐛 16 | 🌐 TeX | 📅 2024-05-23 - Web-based vscode with Git Integration + Copilot + Grammar & Spell Checker + Live Collaboration Support based on GitHub Codespace and Dev container.
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 8 | 🌐 Python | 📅 2026-08-26 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 66 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]

## Bibliography tools

* [Papis](https://github.com/papis/papis) ⭐ 1,769 | 🐛 80 | 🌐 HTML | 📅 2026-08-23 - Extremely customizable,
...
* [tex-fmt](https://github.com/WGUNDERWOOD/tex-fmt) ⭐ 863 | 🐛 34 | 🌐 Rust | 📅 2026-08-22 - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 66 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 66 | 🐛 1 | 🌐 Rust | 📅 2026-08-26 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
