...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 174 | 🐛 28 | 🌐 TypeScript | 📅 2026-09-22 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 29,062 | 🐛 64 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,987 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,366 | 🐛 1 | 🌐 TeX | 📅 2026-09-19 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,159 | 🐛 173 | 🌐 JavaScript | 📅 2026-09-17 (self-hosted, AGPL licensed). ![foss]
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 10 | 🌐 Python | 📅 2026-09-22 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [TexLab](https://github.com/latex-lsp/texlab) ⭐ 2,017 | 🐛 81 | 🌐 Rust | 📅 2026-07-27 - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 78 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 78 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 78 | 🐛 1 | 🌐 Rust | 📅 2026-09-21 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
...
* [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) ⭐ 1,812 | 🐛 2 | 📅 2026-09-21 - Links to various beamer themes along with PDF previews.
