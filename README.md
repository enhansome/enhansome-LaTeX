...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 169 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-18 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 29,046 | 🐛 62 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,332 | 🐛 0 | 🌐 TypeScript | 📅 2026-09-18 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,983 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,363 | 🐛 2 | 🌐 TeX | 📅 2026-09-18 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 8 | 🌐 Python | 📅 2026-09-18 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [Papis](https://github.com/papis/papis) ⭐ 1,782 | 🐛 83 | 🌐 HTML | 📅 2026-09-17 - Extremely customizable,
...
* [tex-fmt](https://github.com/WGUNDERWOOD/tex-fmt) ⭐ 869 | 🐛 38 | 🌐 Rust | 📅 2026-08-22 - Extremely fast LaTeX formatter written in Rust, with sensible defaults and minimal configuration. ![foss]
...
* [Ultimate Beamer Theme List](https://github.com/martinbjeldbak/ultimate-beamer-theme-list) ⭐ 1,811 | 🐛 2 | 📅 2026-06-22 - Links to various beamer themes along with PDF previews.
