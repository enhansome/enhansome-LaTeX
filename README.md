...
* [Oleafly](https://github.com/Oleafly/Oleafly) ⭐ 117 | 🐛 20 | 🌐 TypeScript | 📅 2026-09-02 - Free, open-source desktop editor for LaTeX, Typst, and Markdown with live PDF preview, SyncTeX, bundled engines, and Git-native projects. ![foss]
...
* [VS Code](https://code.visualstudio.com/) [![VS Code][awesome]](https://github.com/viatsko/awesome-vscode) ⭐ 28,996 | 🐛 54 | 🌐 JavaScript | 📅 2026-06-21 ![foss]
  * [LaTeX Workshop](https://github.com/James-Yu/LaTeX-Workshop) ⭐ 12,302 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-02 - LaTeX extension for Visual Studio Code ![foss]
...
* [Vim](https://www.vim.org) [![Vim][awesome]](https://github.com/mhinz/vim-galore) ⭐ 17,971 | 🐛 13 | 🌐 Vim script | 📅 2023-12-22 ![foss]
  * [vimtex](https://github.com/lervag/vimtex) ⭐ 6,354 | 🐛 5 | 🌐 TeX | 📅 2026-08-29 - Modern vim plugin for editing LaTeX files. Has a variety of features including live preview and forward search. ![foss]
...
* [Emacs](https://www.gnu.org/software/emacs/)  [![Emacs][awesome]](https://github.com/emacs-tw/awesome-emacs) ⭐ 9,370 | 🐛 37 | 📅 2026-08-28 ![foss]
...
* [IntelliJ](https://www.jetbrains.com/idea/)
  * [TeXiFy-IDEA](https://github.com/Hannah-Sten/TeXiFy-IDEA) ⭐ 984 | 🐛 6 | 🌐 Kotlin | 📅 2026-09-01 - Free LaTeX plugin for IntelliJ IDEA. ![foss]

### Online editors

Online editors that allow you to edit documents collaboratively.

* [Overleaf](https://www.overleaf.com) - Online editor, also with a WYSIWYM editor and git support. Also available as [Overleaf Community Edition](https://github.com/overleaf/overleaf) ⭐ 18,083 | 🐛 175 | 🌐 JavaScript | 📅 2026-07-10 (self-hosted, AGPL licensed). ![foss]
  * [olcli](https://github.com/aloth/olcli) ⭐ 175 | 🐛 3 | 🌐 TypeScript | 📅 2026-09-01 - Command-line interface for Overleaf to sync, manage, and compile projects from the terminal. ![foss]
...
* [SciTeX Cloud](https://github.com/ywatanabe1989/scitex-cloud) ⭐ 2 | 🐛 8 | 🌐 Python | 📅 2026-08-30 - Self-hostable online editor with AI assistant integration, figure/table/citation management, real-time collaboration, and an MCP server (29 tools). ![foss]
...
* [TexLab](https://github.com/latex-lsp/texlab) ⭐ 2,012 | 🐛 79 | 🌐 Rust | 📅 2026-07-27 - Language server for LaTeX and BibTeX with completion, definitions, references, rename, formatting, and forward search. ![foss]
* [Badness](https://github.com/jolars/badness) ⭐ 69 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Language server, formatter, and linter for LaTeX built on a lossless, error-tolerant syntax tree in the style of rust-analyzer. ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 69 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Deterministic, rule-based, and idempotent LaTeX formatter written in Rust (also a linter and language server). ![foss]
...
* [TeXtidote](https://github.com/sylvainhalle/textidote) ⭐ 1,056 | 🐛 37 | 🌐 Java | 📅 2026-09-01 - A cross-platform (Java) spelling, grammar and style checker for LaTeX documents. ![windows] ![linux] ![mac] ![foss]
...
* [Badness](https://github.com/jolars/badness) ⭐ 69 | 🐛 1 | 🌐 Rust | 📅 2026-09-02 - Error-tolerant LaTeX linter with rich diagnostics and source snippets (also a formatter and language server). ![foss]
* [latex2arxiv](https://github.com/YuZh98/latex2arxiv) ⭐ 5 | 🐛 0 | 🌐 Python | 📅 2026-07-30 - CLI tool that prepares a LaTeX project for arXiv submission: prunes unreachable files, strips draft markup, validates the bibliography, and catches desk-rejection errors before upload. Also available as a GitHub Action and MCP server for AI agents. ![windows] ![linux] ![mac] ![foss]
...
* [PetarV-/TikZ](https://github.com/PetarV-/TikZ) ⭐ 1,418 | 🐛 1 | 🌐 TeX | 📅 2023-05-05 - Collection of publication-ready PGF/TikZ figures by Petar Veličković.
...
* [Awesome LaTeX drawing](https://github.com/xinychen/awesome-latex-drawing) ⭐ 2,049 | 🐛 1 | 🌐 TeX | 📅 2025-05-26 - Curated list of academic drawing examples for using LaTeX
